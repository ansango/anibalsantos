...
date: '2021-08-02'
tags: ['react', 'es6', 'javascript', 'js', 'componentes']
draft: false
summary: Explicación general de los componentes función
cover: /static/blog/react/functional-components.jpg
---
...
const NoResults = (props) =>
  !(props.results && props.results.length > 0) && <span>No hay resultados disponibles</span>
```
...
Puedes continuar leyendo el siguiente capítulo sobre [Class components](/blog/react/class-components), o volver al capítulo de [Introducción](/blog/react/intro)
