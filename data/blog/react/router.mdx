...
Puedes continuar leyendo el siguiente capítulo sobre [Trabajar con backend en React](/blog/react/backend), o volver al capítulo de [Context API](/blog/react/context-api)
