...
date: '2021-09-16'
tags: ['react', 'context', 'devtools']
draft: false
summary: Depurar Context API de ReactJS con React Context Devtool
cover: /static/blog/react/context-dev.jpg
---
...
2. Añade el método `_REACT_CONTEXT_DEVTOOL` in tu `Consumer`.
...
2. Añade `ContextDevTool` dentro de tu `Provider`
