...
draft: false
summary: Como trabajar con el backend en React y debug
...
Congrats! 🎊 has llegado al final de esta guía, puedes volver al capítulo de [React Router](/blog/react/router), o al [Índice](/blog/react/indice).
