---
title: Configurar Ubuntu 20.04
date: '2021-07-17'
tags: ['linux', 'ubuntu', 'zsh', 'nvm', 'tooling', 'pinned']
draft: false
summary: Instalación de utilidades para desarrollo en Ubuntu 20.04
---

<div className="flex justify-center">
  <Image alt="ubuntu" src="/static/blog/linux/ubuntu.jpg" width={768} height={476} />
</div>
