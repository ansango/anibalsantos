...
cover: /static/blog/linux/101-comandos-bash-basicos.jpg
---
...
- [Primeros Comandos, Navegando por el Sistema de Archivos](/blog/linux/101-comandos-bash-basicos/#primeros)
  - `pwd / ls / cd`
  - `; / && / &`
- [Cómo obtener ayuda](/blog/linux/101-comandos-bash-basicos/#ayuda)
  - `-h`
  - `man`
- [Visualización y edición de archivos](/blog/linux/101-comandos-bash-basicos/#visualizacion)
  - `head / tail / cat / less`
  - `nano / nedit`
- [Creación y eliminación de archivos y directorios](/blog/linux/101-comandos-bash-basicos/#creacion)
  - `touch`
  - `mkdir / rm / rmdir`
- [Mover y copiar archivos, hacer enlaces, historial de comandos](/blog/linux/101-comandos-bash-basicos/#mover)
  - `mv / cp / ln`
  - Historial de comandos
- [Árboles de directorios, uso del disco y procesos](/blog/linux/101-comandos-bash-basicos/#arboles)
  - `mkdir –p / tree`
  - `df / du / ps`
- [Miscellaneous](/blog/linux/101-comandos-bash-basicos/#misc-basicos)
  - `passwd / logout / exit`
  - `clear / *`
