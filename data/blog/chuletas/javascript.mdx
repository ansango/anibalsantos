...
<div className="flex justify-center">
  <Image alt="js" src="/static/blog/chuletas/javascript.jpg" width={768} height={476} />
</div>
...
6. [Métodos de array](/blog/chuletas/javascript#arr-methods)
...
11. [Operadores de comparación](/blog/chuletas/javascript#comparacion)
...
15. [Orientación a objetos](/blog/chuletas/javascript#poo)
16. [Orientación a objetos ES6](/blog/chuletas/javascript#poo-es6)
...
Para asegurar que sus datos no cambian, JavaScript proporciona una función Object.freeze para prevenir la mutación de datos.
...
// puede acceder a cualquier valor utilizando comas para llegar al índice deseado
const [a, b, , , c] = [1, 2, 3, 4, 5, 6]
console.log(a, b, c) // 1, 2, 5

// para recoger el resto de los elementos en un array separado.
