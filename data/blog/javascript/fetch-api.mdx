...
title: fetch API
date: '2021-06-06'
tags: ['javascript', 'fetch', 'ajax']
draft: false
summary: El pasado Ajax y el presente con Fetch API
---

<div className="flex justify-center">
  <Image alt="fetch" src="/static/blog/javascript/fetch.jpg" width={768} height={476} />
</div>
...
1. [XMLHttpRequest](/blog/javascript/fetch-api#xml)
2. [Uso básico de fetch](/blog/javascript/fetch-api#fetch)
3. [Headers](/blog/javascript/fetch-api#headers)
4. [Request](/blog/javascript/fetch-api#request)
5. [Response](/blog/javascript/fetch-api#response)
6. [Manejo de JSON](/blog/javascript/fetch-api#json)
7. [Manejo de respuestas básicas de texto/HTML](/blog/javascript/fetch-api#text-html)
8. [Manejo de las respuestas Blob](/blog/javascript/fetch-api#blob)
9. [Envío de datos](/blog/javascript/fetch-api#data)
