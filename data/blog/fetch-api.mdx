...
1. [XMLHttpRequest](/blog/fetch-api#xml)
2. [Uso básico de fetch](/blog/fetch-api#fetch)
3. [Headers](/blog/fetch-api#headers)
4. [Request](/blog/fetch-api#request)
5. [Response](/blog/fetch-api#response)
6. [Manejo de JSON](/blog/fetch-api#json)
7. [Manejo de respuestas básicas de texto/HTML](/blog/fetch-api#text-html)
8. [Manejo de las respuestas Blob](/blog/fetch-api#blob)
9. [Envío de datos](/blog/fetch-api#data)
10. [Conclusiones](/blog/fetch-api#end)
